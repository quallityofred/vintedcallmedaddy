...
## тШБп╕П ╨Я╨╡╤А╨╡╤Е╨╛╨┤ ╨▓ ╨Ю╨▒╨╗╨░╨║╨╛ (PostgreSQL)

╨С╨╛╤В ╨┐╨╛╨┤╨┤╨╡╤А╨╢╨╕╨▓╨░╨╡╤В ╤А╨░╨▒╨╛╤В╤Г ╤Б ╨╛╨▒╨╗╨░╤З╨╜╤Л╨╝╨╕ ╨С╨Ф (╨╜╨░╨┐╤А╨╕╨╝╨╡╤А, **Supabase** ╨╕╨╗╨╕ **Neon**), ╤З╤В╨╛ ╨┐╨╛╨╖╨▓╨╛╨╗╤П╨╡╤В ╤Г╨┤╨╛╨▒╨╛ ╨┐╤А╨╛╤Б╨╝╨░╤В╤А╨╕╨▓╨░╤В╤М ╨┤╨░╨╜╨╜╤Л╨╡ ╤З╨╡╤А╨╡╨╖ ╨▒╤А╨░╤Г╨╖╨╡╤А.

### 1. ╨б╨╛╨╖╨┤╨░╨╜╨╕╨╡ ╨С╨Ф (Supabase)
1. ╨Ч╨░╤А╨╡╨│╨╕╤Б╤В╤А╨╕╤А╤Г╨╣╤В╨╡╤Б╤М ╨╜╨░ [Supabase.com](https://supabase.com/).
2. ╨б╨╛╨╖╨┤╨░╨╜╨╕╤В╨╡ ╨╜╨╛╨▓╤Л╨╣ ╨┐╤А╨╛╨╡╨║╤В.
3. ╨Я╨╡╤А╨╡╨╨╣╨┤╨╕╤В╨╡ ╨▓ **Project Settings** -> **Database**.
4. ╨б║╨╛╨┐╨╕╤А╤Г╨╣╤В╨╡ **Connection String** (URI) ╨┤╨╗╤П `Transaction` ╤А╨╡╨╢╨╕╨╝╨░.
5. ╨Ч╨░╨╝╨╡╨╜╨╕╤В╨╡ `postgresql://` ╨╜╨░ `postgresql+asyncpg://`.

### 2. ╨Э╨░╤Б╤В╤А╨╛╨╣╨║╨░ .env
╨Ю╨▒╨╛╨▓╨╕╤В╨╡ `DATABASE_URL` ╨▓ ╨▓╨░╤И╨╡╨╝ `.env`:
```env
DATABASE_URL=postgresql+asyncpg://postgres:[YOUR_PASSWORD]@db.[PROJECT_REF].supabase.co:5432/postgres
```

### 3. ╨Я╨╡╤А╨╡╨╜╨╛╤Б ╨┤╨░╨╜╨╜╤Л╤Е
╨Х╤Б╨╗╨╕ ╤Г ╨▓╨░╤Б ╨╡╤Б╤В╤М ╨┤╨░╨╜╨╜╤Л╨╡ ╨▓ ╨╗╨╛╨║╨░╨╗╤М╨╜╨╛╨╣ SQLite, ╨╖╨░╨┐╤Г╤Б╤В╨╕╤В╨╡ ╤Б╨║╤А╨╕╨┐╤В ╨╝╨╕╨│╤А╨░╤Ж╨╕╨╕:
```bash
python scripts/migrate_to_pg.py
```

### 4. ╨Я╤А╨╛╤Б╨╝╨╛╤В╤А ╨С╨Ф ╤З╨╡╤А╨╡╨╖ ╨▒╤А╨░╤Г╨╖╨╡╤А
1. ╨Ч╨░╨╣╨┤╨╕╤В╨╡ ╨▓ ╨┐╨░╨╜╨╡╨╗╤М Supabase.
2. ╨Э╨░╨╢╨╝╨╕╤В╨╡ ╨╜╨░ **Table Editor** ╨▓ ╨╗╨╡╨▓╨╛╨╝ ╨╝╨╡╨╜╤О.
3. ╨Т╤Л ╤Г╨▓╨╕╨┤╨╕╤В╨╡ ╨▓╤Б╨╡ ╤В╨░╨▒╨╗╨╕╤Ж╤Л: `users`, `monitors`, `found_items` ╨╕ ╨┤╤А.
