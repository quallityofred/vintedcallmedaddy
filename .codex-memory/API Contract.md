...
- `GET /api/health` includes safe candidate-detail guard fields: `monitor_candidate_detail_max_per_check`, `monitor_detail_guard_enabled`, `monitor_detail_category_guard_enabled`, and `monitor_detail_freshness_guard_enabled`. Boolean guard fields are numeric `0`/`1` in this scheduler/backpressure section.
